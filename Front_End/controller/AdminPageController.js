    ...
    $("#btnCustomer").on("click", function () {
        ...
        function bindDeleteEvent() {
            $(".btnDelete").on("click", function () {
                ...
                if (!confirm("Are You delete this surely")) return;
        ...
        customerValidations.push({
            reg: cusNameRegEx,
            field: $('#cusName'),
            error: 'Customer Name Pattern is Wrong'
        });
        customerValidations.push({
            reg: cusNicRegEx,
            field: $('#cusNic'),
            error: 'NIC Pattern is Wrong'
        });
        customerValidations.push({
            reg: cusNicRegEx,
            field: $('#cusLicense'),
        ...
        customerValidations.push({
            reg: cusContactRegEx,
            field: $('#cusContact'),
            error: 'Contact Pattern is Wrong '
        });
        customerValidations.push({
            reg: cusEmailRegEx,
            field: $('#cusEmail'),
            error: 'Email Pattern is Wrong'
        });
        customerValidations.push({
            reg: cusAddressRegEx,
            field: $('#cusUsername'),
...
function manageCarPage() {
    $("#btnCar").on("click", function () {
            ...
            $(".btnUpdate").on("click", function () {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $("#backImgContext").attr(`style`, `background : url(../assets${res.data.photos.back1}); background-position: center; background-size: cover`)
        ...
        function loadAllCars(cars) {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <section class="mb-4">
                        <img src="../assets/${car.photos.back1}" class="w-25 h-25" alt="${car.photos.back1}">
        ...
        carValidations.push({
            reg: regNumRegEx,
            field: $('#regNum'),
            error: 'Car Number Pattern is Wrong'
        });
        carValidations.push({
            reg: colorRegEx,
            field: $('#color'),
...
function manageDriverPage() {
    $("#btnDriver").on("click", function () {
        ...
        driverValidations.push({
            reg: cusNicRegEx,
            field: $('#license'),
            error: 'License Pattern is Wrong'
        });
        driverValidations.push({
            reg: cusAddressRegEx,
            field: $('#address'),
            error: 'Address Pattern is Wrong'
        });
        driverValidations.push({
            reg: cusContactRegEx,
            field: $('#contact'),
