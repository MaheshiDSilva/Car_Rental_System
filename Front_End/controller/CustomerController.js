        ...
        function loadAllCars(cars) {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <section class="mb-4">
                        <img src="../assets/${car.photos.back1}" class="w-25" alt="${car.photos.back1}">
...
function managePaymentPage() {
    ...
    $("#btnManagePayment").on("click", function () {
        ...
        $.ajax({
            url: baseUrl + `payment?nic=` + customer.nic, method: "get", dataType: "json", success: function (res) {
...
$("#btnRequestCar").on("click", function () {
    ...
    let json = {
        ...
        rentDetails: [{
            rentId: rentId, nic: null, regNum: regNum, driverCost: $("#driverCost").val(), carCost: $("#carCost").val()
        }]
    ...
    if ($(this).text() == "Request") {
        ...
        Al.fire({
            position: 'top-end', icon: 'success', title: 'Successfully Added..!', showConfirmButton: false, timer: 1500
        });
    }
...
$("#btnUpdateCustomer").on("click", function () {
    ...
    let json = {
        ...
        email: $("#cusEmail").val(),
        user: {
            username: $("#cusUsername").val(), password: $("#cusPassword").val(),
        }
...
$.ajax({
    url: baseUrl + "rent?nic=" + customer.nic, async: false, method: "get", dataType: "json", success: function (res) {
